...
*************************/
  ...
  $("#submit").click(function () {
    ...
    if (
      ...
      $.ajax({
        url: "https://script.google.com/macros/s/AKfycbyrF_V6mcgStso25kH6-HM9QikRy2ogKxmrZT_GDKJ-3-z8MTAMaNaDIF1TaMvg0gQF6Q/exec", // replace this with your deployed Web App URL
        type: "POST",
        data: data1, // sending raw form-style data
        success: function (res) {
          alert("Thank you for connecting with Vestigo! We will get back to you.");
          // console.log(res);
      ...
      /* $.ajax({
        ...
        success: function addCell(data) {
          alert("Thank you for connecting Vestigo !! We will get back to you.");
          console.log(data);
          $("#cformopacity").css("opacity", "1");
          $("#formloader").hide();
        },
      ...
      alert("Please provide require details.");
      $("#cformopacity").css("opacity", "1");
      $("#formloader").hide();
    }
  });
        ...
        submitHandler: function (form) {
          ...
          jQuery.ajax({
            ...
            success: function (data) {
              ...
              var alertBox =
                '<div id="form-result" class="alert ' +
                msgAlert +
